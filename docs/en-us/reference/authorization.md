...
- Minimal permissions, only supports `connect` command running with default parameters: [connect-only-mini.yaml](https://github.com/gitlayzer/kt-connect/blob/master/docs/deploy/rbac/connect-only-mini.yaml)
- Support full functionality using `connect` command: [connect-only-full.yaml](https://github.com/gitlayzer/kt-connect/blob/master/docs/deploy/rbac/connect-only-full.yaml)
- Supports all commands with default parameters: [all-commands-mini.yaml](https://github.com/gitlayzer/kt-connect/blob/master/docs/deploy/rbac/all-commands-mini.yaml)
- Supports full functionality of all commands: [all-commands-full.yaml](https://github.com/gitlayzer/kt-connect/blob/master/docs/deploy/rbac/all-commands-full.yaml)
